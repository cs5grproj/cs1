...
public class AnswerService {
     ...
     * @param answerEntity object with unique randomly generated answer UUID and answer content passed in the Answer Request
     ...
     * @throws InvalidQuestionException if question id passed to the method doesn't exists in answer table
     */
     ...
     * @param answerId
     * @param authorizationToken
     * @param answerEntity object - contains the answer content which is passed in the edit answer request
     * @return AnswerEntity object of the edited answer record from answer table
     * @throws AnswerNotFoundException if answer uuid passed in the request doesn't exist in answer table
     * @throws AuthorizationFailedException if authorization is failed
     */
    @Transactional(propagation = Propagation.REQUIRED)
     ...
     * @param questionId
     * @param authorizationToken
     * @return List of AnswerEntity objects that contains the all the answers from answer table for the specific function
     * @throws AuthorizationFailedException if authorization is failed
     * @throws InvalidQuestionException if question id passed to the method doesn't exists in answer table
     */
    @Transactional(propagation = Propagation.REQUIRED)
