...
@NamedQueries({
        ...
        @NamedQuery(name = "logInUserAuthTokenByAccessToken", query = "select ut from UserAuthTokenEntity ut where ut.accessToken =:accessToken and ut.logoutAt is not null")
})
