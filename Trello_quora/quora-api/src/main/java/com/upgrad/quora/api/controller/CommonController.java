...
public class CommonController {
    ...
    public ResponseEntity<UserDetailsResponse> userProfile(String userId, String bearerAuthorization) throws AuthorizationFailedException, UserNotFoundException {
